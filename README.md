...
4.The client_action function represents the behavior of each client. It generates a random amount of current needed, checks if there's space in the queue, selects a pump (based on the client ID), and starts 
charging. It simulates both grid charging and charging from solar panels.
